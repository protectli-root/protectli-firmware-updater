...
CONFIGURATIONS = types.MappingProxyType({
    ...
    'v1210': {
        ...
        'bios': [
            ...
            {
                'vendor': 'coreboot',
                'file': 'protectli_v1210_v0.9.4.rom',
    ...
    'v1211': {
        ...
        'bios': [
            ...
            {
                'vendor': 'coreboot',
                'file': 'protectli_v1211_v0.9.4.rom',
    ...
    'v1410': {
        ...
        'bios': [
            ...
            {
                'vendor': 'coreboot',
                'file': 'protectli_v1410_v0.9.4.rom',
    ...
    'v1610': {
        ...
        'bios': [
            ...
            {
                'vendor': 'coreboot',
                'file': 'protectli_v1610_v0.9.4.rom',
    ...
    'vp2420': {
        ...
        'bios': [
            ...
            {
                'vendor': 'coreboot',
                'file': 'protectli_vp2420_v1.2.1.rom',
            },
        ],
        'command': vp24_vp66_command,
    ...
    'vp2440': {
        ...
        'bios': [
            {
                'vendor': 'ami',
                'file': 'vp2440_PANDZ2F2L11.bin',
            },
            {
                'vendor': 'coreboot',
                'file': 'protectli_vp2440_v0.9.1-rc3.rom',
            },
        ],
        'command': vp24_vp66_command,
    },
    'vp3210': {
        ...
        'bios': [
            {
                'vendor': 'ami',
                'file': 'vp3210_PANDZ2L110.bin',
            },
            {
                'vendor': 'coreboot',
                'file': 'protectli_vp3200_v0.9.0.rom',
            },
        ],
        'command': vp24_vp66_command,
    },
